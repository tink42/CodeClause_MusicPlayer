...
# frames
song_frame = LabelFrame(root, text='Current Song', bg='Pink', width=600, height=450)
song_frame.place(x=0, y=0)

button_frame = LabelFrame(root, text='Control Buttons', bg='Pink', width=600, height=450)
...
# SongFrame Labels
Label(song_frame, text='CURRENTLY PLAYING:', bg='Pink', font=('Times', 10, 'bold')).place(x=15, y=20)
...
load_btn = Button(button_frame, text='Load Directory', bg='White', font=("Georgia", 13), width=35,
                  command=lambda: load(playlist))
load_btn.place(x=10, y=55)

# Label at the bottom that displays the state of the music
Label(root, textvariable=song_status, bg='Pink', font=('Times', 9), justify=LEFT).pack(side=BOTTOM, fill=X)
